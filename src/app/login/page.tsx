    ...
    <div className="min-h-screen flex items-center justify-center bg-gradient-to-br from-green-50 to-orange-50 py-12 px-4 sm:px-6 lg:px-8">
      <div className="max-w-md w-full space-y-8">
        ...
        <div className="text-center mb-8">
          <h2 className="font-anton text-4xl inline-block">
            <Link href="/">
              <span className="text-mtaka-green">CRI</span>
              <span className="text-practical-orange">CHOW</span>
            </Link>
            <span className="pl-3 uppercase text-dark-gray">Analytics</span>
          </h2>
          ...
          <form onSubmit={handleSubmit} className="space-y-3">
            <div>
              ...
              <input
                ...
                type="text"
                required
                className="appearance-none relative block w-full px-4 py-3 border border-gray-300 placeholder-gray-500 text-gray-900 rounded-md focus:outline-none focus:ring-2 focus:ring-mtaka-green focus:border-mtaka-green text-center text-lg sm:text-sm tracking-widest"
